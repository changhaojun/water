...
function listData(data,i){
	...
	if(selectedId.indexOf(data[i].data_id)!=-1 && selectedData.indexOf(data[i].data_id)!=-1){
		title='<span class="fa fa-plus-square disabledLi focus1" data-toggle="tooltip" data-placement="top" title="已关注"></span>'+
	...
	//没关注，已设封面
		title='<span class="fa fa-plus-square focus1" data-toggle="tooltip" data-placement="top" title="关注" hidden="hidden"></span>'+
			'<span class="fa fa-list-alt disabledLi cover" data-toggle="tooltip" data-placement="top" title="已设封面"></span>'			
	}else{
	//没关注，没设封面
		title='<span class="fa fa-plus-square focus1" data-toggle="tooltip" data-placement="top" title="关注" hidden="hidden"></span>'+
...
function showDisplay(){
	$(".dataList").hover(function(){
		...
		$(this).find(".disabledLi").css("display","block");
	})
}
